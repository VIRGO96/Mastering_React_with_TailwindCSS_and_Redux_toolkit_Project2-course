  ...
  return (
    <div>
      <div className="grid grid-cols-12">
        <div className="bg-primary col-span-12 lg:col-span-6 lg:pl-[17%]">
        ...
        <div className="bg-white col-span-12 lg:col-span-6 pr-[17%]">
          <div className="p-6 lg:p-10">
            <div className="flex items-center">
              <div className="w-10 md:w-16 h-10 md:h-16 bg-primary rounded-full flex justify-center items-center">
      ...
      <div className="grid grid-cols-12">
        ...
        <div className="bg-secondary col-span-12 lg:col-span-6 pr-[17%]">
          <div className="p-6 lg:p-10">
