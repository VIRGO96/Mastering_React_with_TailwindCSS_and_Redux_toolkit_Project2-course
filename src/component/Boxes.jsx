  ...
  return (
    <>
      <div className="grid h-[400px] grid-cols-12">
        <div className="bg-primary flex items-center pr-16 pl-[17%] col-span-12 lg:col-span-6">
          <BoxText
        ...
        <div className="bg-secondary flex items-center pl-16 pr-[17%] col-span-12 lg:col-span-6">
          <BoxText
      ...
      <div className="grid h-[400px] grid-cols-12">
        <div className="bg-secondary flex items-center pr-16 pl-[17%] col-span-12 lg:col-span-6">
          <BoxText
        ...
        <div className="bg-primary flex items-center pl-16 pr-[17%] col-span-12 lg:col-span-6">
          <BoxText
